...
pub const INSTRUCTIONS_BY_OPCODES: [Instruction; INSTRUCTIONS_LEN] = {
    ...
    instructions[0x0E] = Instruction::new(
        ...
        Cpu::fetch_execute_ld_r_d8::<{ RegisterType::C as u8 }>,
    );
    ...
    instructions[0x11] = Instruction::new(
        ...
        Cpu::fetch_execute_ld_r_d16::<{ RegisterType::DE as u8 }>,
    );
    ...
    instructions[0x16] = Instruction::new(
        ...
        Cpu::fetch_execute_ld_r_d8::<{ RegisterType::D as u8 }>,
    );
    ...
    instructions[0x1E] = Instruction::new(
        ...
        Cpu::fetch_execute_ld_r_d8::<{ RegisterType::E as u8 }>,
    );
    ...
    instructions[0x21] = Instruction::new(
        ...
        Cpu::fetch_execute_ld_r_d16::<{ RegisterType::HL as u8 }>,
    );
    ...
    instructions[0x31] = Instruction::new(
        ...
        Cpu::fetch_execute_ld_r_d16::<{ RegisterType::SP as u8 }>,
    );
    ...
    instructions[0x36] = Instruction::new(
        ...
        Cpu::fetch_execute_ld_mr_d8::<{ RegisterType::HL as u8 }>,
    );
    ...
    instructions[0xB0] = Instruction::new(
        ...
        Cpu::fetch_execute_or_r_r::<{ RegisterType::A as u8 }, { RegisterType::B as u8 }>,
    );
    instructions[0xB1] = Instruction::new(
        ...
        Cpu::fetch_execute_or_r_r::<{ RegisterType::A as u8 }, { RegisterType::C as u8 }>,
    );
    instructions[0xB2] = Instruction::new(
        ...
        Cpu::fetch_execute_or_r_r::<{ RegisterType::A as u8 }, { RegisterType::D as u8 }>,
    );
    instructions[0xB3] = Instruction::new(
        ...
        Cpu::fetch_execute_or_r_r::<{ RegisterType::A as u8 }, { RegisterType::E as u8 }>,
    );
    instructions[0xB4] = Instruction::new(
        ...
        Cpu::fetch_execute_or_r_r::<{ RegisterType::A as u8 }, { RegisterType::H as u8 }>,
    );
    instructions[0xB5] = Instruction::new(
        ...
        Cpu::fetch_execute_or_r_r::<{ RegisterType::A as u8 }, { RegisterType::L as u8 }>,
    );
    ...
    instructions[0xB7] = Instruction::new(
        ...
        Cpu::fetch_execute_or_r_r::<{ RegisterType::A as u8 }, { RegisterType::A as u8 }>,
    );
    ...
    instructions[0xC5] = Instruction::new(
        ...
        Cpu::fetch_execute_push::<{ RegisterType::BC as u8 }>,
    );
    ...
    instructions[0xD8] = Instruction::new(
        ...
        Cpu::execute_ret::<{ ConditionType::C as u8 }>,
    );
    ...
    instructions[0xDC] = Instruction::new(
        ...
        Cpu::fetch_execute_call_d16::<{ ConditionType::C as u8 }>,
    );
    ...
    instructions[0xE1] = Instruction::new(
        ...
        Cpu::fetch_execute_pop::<{ RegisterType::HL as u8 }>,
    );
    ...
    instructions[0xE5] = Instruction::new(
        ...
        Cpu::fetch_execute_push::<{ RegisterType::HL as u8 }>,
    );
    ...
    instructions[0xEA] = Instruction::new(
        ...
        Cpu::fetch_execute_ld_a16_r::<{ RegisterType::A as u8 }>,
    );
    ...
    instructions[0xEE] = Instruction::new(
        ...
        Cpu::fetch_execute_xor_r_d8::<{ RegisterType::A as u8 }>,
    );
    ...
    instructions[0xF1] = Instruction::new(
        ...
        Cpu::fetch_execute_pop::<{ RegisterType::AF as u8 }>,
    );
    ...
    instructions[0xFA] = Instruction::new(
        ...
        Cpu::fetch_execute_ld_r_a16::<{ RegisterType::A as u8 }>,
    );

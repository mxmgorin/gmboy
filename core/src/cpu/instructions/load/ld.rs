use crate::cpu::instructions::{AddressMode, InstructionSpec};
use crate::cpu::instructions::{DataDestination, DataSource, FetchedData};
use crate::cpu::{Cpu, RegisterType};

impl Cpu {
    #[inline]
    pub fn execute_ld(&mut self, fetched_data: FetchedData, spec: InstructionSpec) {
        match fetched_data.dest {
            DataDestination::Register(r) => {
                if spec.addr_mode == AddressMode::LH_SPi8 {

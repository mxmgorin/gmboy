...
pub fn get_char_bitmap(c: char, size: FontSize) -> Option<Box<[u8]>> {
    match size {
        ...
        FontSize::Font5x5 => char_bitmap_5x5(c).map(Box::from),
...
fn char_bitmap_5x5(ch: char) -> Option<[u8; 5]> {
    Some(match ch {
...
fn char_bitmap_5x6(c: char) -> Option<[u8; 6]> {
    match c {
        ...
        '[' => Some([0b11110, 0b10000, 0b10000, 0b10000, 0b10000, 0b11110]),
        ']' => Some([0b11110, 0b00010, 0b00010, 0b00010, 0b00010, 0b11110]),

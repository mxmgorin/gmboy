...
pub const fn char_bitmap_3x4(c: char) -> &'static [u8; 4] {
    match c {
        ...
        '/' => &[0b001, 0b010, 0b100, 0b000],
        '\\' => &[0b100, 0b010, 0b001, 0b000],
        '…' => &[0b000, 0b000, 0b101, 0b000],
        _ => &[0b000; 4],
    }
}
...
pub const fn char_bitmap_5x6(c: char) -> &'static [u8; 6] {
    match c {
        ...
        '/' => &[0b00000, 0b00001, 0b00010, 0b00100, 0b01000, 0b10000],
        '\\' => &[0b00000, 0b10000, 0b01000, 0b00100, 0b00010, 0b00001],

...
use emu::bus::Bus;
use emu::cpu::instructions::opcodes::INSTRUCTIONS_BY_OPCODES;
use emu::cpu::instructions::ExecutableInstruction;
use emu::cpu::{CounterCpuCallback, Cpu, Flags, Registers};
...
impl Sm83TestCase {
    ...
    pub fn _assert_final_state(&self, cpu: &Cpu) {
        ...
        // todo: re-search
        //assert_eq!(cpu.auxiliary.io.interrupts.ie_register, self.final_state.ie);
